...
inline void *__gmp_default_allocate (size_t);
inline void *__gmp_default_reallocate (void *, size_t, size_t);
inline void __gmp_default_free (void *, size_t);
...
mp_limb_t mpn_mod_1c (mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t) __GMP_ATTRIBUTE_PURE;
...
mp_limb_t mpn_mod_1_1p (mp_srcptr, mp_size_t, mp_limb_t, const mp_limb_t [4]) __GMP_ATTRIBUTE_PURE;
#endif
...
mp_limb_t mpn_mod_1s_2p (mp_srcptr, mp_size_t, mp_limb_t, const mp_limb_t [5]) __GMP_ATTRIBUTE_PURE;
#endif
...
mp_limb_t mpn_mod_1s_3p (mp_srcptr, mp_size_t, mp_limb_t, const mp_limb_t [6]) __GMP_ATTRIBUTE_PURE;
#endif
...
mp_limb_t mpn_mod_1s_4p (mp_srcptr, mp_size_t, mp_limb_t, const mp_limb_t [7]) __GMP_ATTRIBUTE_PURE;
#endif
...
#ifndef __gmp_rands_initialized_X
#define  __gmp_rands_initialized_X
...
mp_limb_t mpn_dcpi1_divappr_q_n (mp_ptr, mp_ptr, mp_srcptr, mp_size_t, gmp_pi1_t *, mp_ptr);
...
mp_size_t mpn_mu_div_qr_choose_in (mp_size_t, mp_size_t, int);
...
mp_size_t mpn_mu_divappr_q_choose_in (mp_size_t, mp_size_t, int);

// #define   mpn_preinv_mu_divappr_q __MPN(preinv_mu_divappr_q)
mp_limb_t mpn_preinv_mu_divappr_q (mp_ptr, mp_srcptr, mp_size_t, mp_srcptr, mp_size_t, mp_srcptr, mp_size_t, mp_ptr);
...
void      mpn_dcpi1_bdiv_q_n (mp_ptr, mp_ptr, mp_srcptr, mp_size_t, mp_limb_t, mp_ptr);
// #define   mpn_dcpi1_bdiv_q_n_itch __MPN(dcpi1_bdiv_q_n_itch)
mp_size_t mpn_dcpi1_bdiv_q_n_itch (mp_size_t) ATTRIBUTE_CONST;
...
int     mpn_divisible_p (mp_srcptr, mp_size_t, mp_srcptr, mp_size_t) __GMP_ATTRIBUTE_PURE;
...
#define CNST_LIMB(x) ((uint64_t)(x))

#include "mpn/comb_tables.c"
...
void __gmp_assert_fail (const char *, int, const char *) ATTRIBUTE_NORETURN;
...
mp_limb_t mpn_mod_34lsub1 (mp_srcptr, mp_size_t) __GMP_ATTRIBUTE_PURE;
#endif
...
mp_limb_t mpn_modexact_1c_odd (mp_srcptr, mp_size_t, mp_limb_t, mp_limb_t) __GMP_ATTRIBUTE_PURE;
#endif

#if HAVE_NATIVE_mpn_modexact_1_odd
// #define   mpn_modexact_1_odd  __MPN(modexact_1_odd)
mp_limb_t mpn_modexact_1_odd (mp_srcptr, mp_size_t, mp_limb_t) __GMP_ATTRIBUTE_PURE;
#else
...
double mpn_get_d (mp_srcptr, mp_size_t, mp_size_t, long) __GMP_ATTRIBUTE_PURE;
...
// unsigned char __gmp_digit_value_tab[];

#include "mp_bpl.c"
// int __gmp_junk;
// int __gmp_0;
 void __gmp_exception (int) ATTRIBUTE_NORETURN;
 void __gmp_divide_by_zero (void) ATTRIBUTE_NORETURN;
 void __gmp_sqrt_of_negative (void) ATTRIBUTE_NORETURN;
 void __gmp_invalid_operation (void) ATTRIBUTE_NORETURN;
...
void      mpn_matrix22_mul_strassen (mp_ptr, mp_ptr, mp_ptr, mp_ptr, mp_size_t, mp_srcptr, mp_srcptr, mp_srcptr, mp_srcptr, mp_size_t, mp_ptr);
...
void mpn_set_str_compute_powtab (powers_t *powtab, mp_ptr powtab_mem, mp_size_t un, int base);
mp_size_t mpn_bc_set_str (mp_ptr, const unsigned char *, size_t, int);
mp_size_t mpn_dc_set_str (mp_ptr, const unsigned char *, size_t, const powers_t *, mp_ptr);
...
#define DIGITS_IN_BASE_PER_LIMB(res, nlimbs, b)				\
  do {									\
    mp_limb_t _ph, _dummy;						\
    umul_ppmm(_ph, _dummy, mp_bases[b].logb2, GMP_NUMB_BITS * (mp_limb_t) (nlimbs));\
    res = _ph;								\
  } while (0)
...
mp_size_t			sqr_basecase_threshold;
#endif
...
void __gmp_randinit_mt_noseed (gmp_randstate_t state){
    // todo anno should do sth ;)
