...
mp_size_t mpn_preinv_mu_div_qr_itch (mp_size_t nn, mp_size_t dn, mp_size_t in);
mp_size_t mpn_mu_div_qr_choose_in (mp_size_t qn, mp_size_t dn, int k);
mp_limb_t mpn_preinv_mu_div_qr (mp_ptr qp,
		      mp_ptr rp,
		      mp_srcptr np,
		      mp_size_t nn,
		      mp_srcptr dp,
