...
#undef ap1 //(pp)		/* n, most significant limb in ap1_hi */
#undef bp1// (pp + n)		/* n, most significant bit in bp1_hi */
#undef am1 //(pp + 2*n)		/* n, most significant bit in hi */
#undef bm1 //(pp + 3*n)		/* n */
#undef v1// (scratch)		/* 2n + 1 */
#undef vm1 //(pp)		/* 2n + 1 */
#undef scratch_out //(scratch + 2*n + 1) /* Currently unused. */
#undef a0 // ap
#undef a1  //(ap + n)
#undef a2 // (ap + 2 * n)
#undef b0 // bp
