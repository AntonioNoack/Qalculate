...
#undef v0  //  pp				/* 2n */
#undef v1   // (pp + 2 * n)			/* 2n+1 */
#undef vinf // (pp + 6 * n)			/* s+t */
#undef v2  //  scratch				/* 2n+1 */
#undef vm2 //  (scratch + 2 * n + 1)		/* 2n+1 */
#undef vh  //  (scratch + 4 * n + 2)		/* 2n+1 */
#undef vm1 //  (scratch + 6 * n + 3)		/* 2n+1 */
#undef tp //(scratch + 8*n + 5)

  /* apx and bpx must not overlap with v1 */
#undef apx //  pp				/* n+1 */
#undef amx //  (pp + n + 1)			/* n+1 */
#undef bmx  // (pp + 2*n + 2)			/* n+1 */
#undef bpx //  (pp + 4*n + 2)			/* n+1 */