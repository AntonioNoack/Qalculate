...
int mpfr_y0 (mpfr_ptr res, mpfr_srcptr z, mpfr_rnd_t r)
{
  return mpfr_yn (res, 0, z, r);
}

int mpfr_y1 (mpfr_ptr res, mpfr_srcptr z, mpfr_rnd_t r)
{
...
*/
static mpfr_exp_t mpfr_yn_s1 (mpfr_ptr s, mpfr_srcptr y, unsigned long n)
{
  unsigned long k;
  mpz_t f;
  mpfr_exp_t e, emax;
