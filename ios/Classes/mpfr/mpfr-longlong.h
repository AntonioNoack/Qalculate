...
// UWtype __MPN(udiv_qrnnd) (UWtype *, UWtype, UWtype, UWtype);
...
// __longlong_h_C UWtype mpn_umul_ppmm_r (UWtype, UWtype, UWtype *);
...
// __longlong_h_C UWtype mpn_udiv_qrnnd_r (UWtype, UWtype, UWtype, UWtype *);
