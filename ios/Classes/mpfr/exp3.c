...
mpfr_exp_3 (mpfr_ptr y, mpfr_srcptr x, mpfr_rnd_t rnd_mode)
{
  ...
  Prec17 = realprec + shift + 2 + shift_x;
  mpfr_init2 (t, Prec17);
  mpfr_init2 (tmp, Prec17);
  mpz_init (uk);
  ...
  for (;;)
    {
      ...
      k = MPFR_INT_CEIL_LOG2 (Prec17) - MPFR_LOG2_GMP_NUMB_BITS;
      ...
      Prec17 = realprec + shift + 2 + shift_x;
      mpfr_set_prec (t, Prec17);
      mpfr_set_prec (tmp, Prec17);
    }
