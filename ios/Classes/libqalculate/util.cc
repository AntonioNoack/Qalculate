#ifndef ANNO_PROTECT_783394348
#define ANNO_PROTECT_783394348
/*
    Qalculate (library)
...
// anno Android doesn't have it
#define PTHREAD_CANCEL_ENABLE 0
#define PTHREAD_CANCEL_ASYNCHRONOUS 0
// void pthread_setcanceltype(int type, char* value){}
// void pthread_setcancelstate(int type, char* value){}
...
char *locale_from_utf8(const char *str) {
	...
	return dest;*/
	return NULL;// is utf8 anyways on Android
}
